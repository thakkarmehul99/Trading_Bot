...
from Trading_Bot.stock_frame import StockFrame 
...
class Indicators():
    ...
    def rsi(self, period:int, method:str='wilders')-> pd.DataFrame:
        ...
        if 'change_in_price' not in self._frame.columns:
            ...
            #Add RSI Indicator to the frame
        ...
        def sma(self, period: int)->pd.DataFrame:
            ...
            self._current_indicators[column_name]={}
            self._current_indicators[column_name]['args']=locals_data
            self._current_indicators[column_name]['func']=self.stock_frame
        ...
        def refresh(self):
            ...
            #loop through the stored indicators
