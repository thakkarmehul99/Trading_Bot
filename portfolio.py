...
class Portfolio():
    ...
    def add_position(self, symbol:str, asset_type:str, quantity:int=0, purchase_price:float=0.0, purchase_date:Optional[str])->dict:
    ...
    def remove_position(self,symbol)->Tuple[bool,str]:
